...
EXCEL_PATH = "/content/drive/MyDrive/ocr_training/Book3.xlsx"
...
def main():
    ...
    if "qa_chain" not in st.session_state:
        if os.path.exists(INDEX_PATH):
            ...
            with st.spinner("📚 Embedding default medical file..."):
                docs = load_medical_docs("/content/drive/MyDrive/ocr_training/Clinical Pharmacology - D R Laurence.pdf")
    ...
    # ===== الشريط الجانبي =====
    with st.sidebar:
        st.image("/content/drive/MyDrive/ocr_training/Chaty medx.jpg", width=100)
